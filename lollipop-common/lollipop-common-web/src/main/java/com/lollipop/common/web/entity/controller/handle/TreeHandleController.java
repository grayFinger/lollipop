...
import com.lollipop.common.core.web.entity.base.TreeEntity;
import com.lollipop.common.web.entity.controller.BaseController;
import com.lollipop.common.web.entity.service.ITreeService;
...
public abstract class TreeHandleController<Q extends TreeEntity<D>, D extends TreeEntity<D>, IDS extends ITreeService<Q, D>> extends BaseController<Q, D, IDS> {
     ...
     * @see com.lollipop.common.web.entity.controller.TreeController#listExNodes(TreeEntity)
     */
     ...
     *
     * @param d 待新增数据对象
     * @see com.lollipop.common.web.entity.controller.TreeController#add(D)
     */
     ...
     *
     * @param d 待修改数据对象
     * @see com.lollipop.common.web.entity.controller.TreeController#edit(D)
     * @see com.lollipop.common.web.entity.controller.TreeController#editForce(D)
     */
     ...
     * @see com.lollipop.common.web.entity.controller.TreeController#batchRemove(List)
     */
