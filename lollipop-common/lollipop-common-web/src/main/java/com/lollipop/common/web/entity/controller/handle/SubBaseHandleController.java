...
import com.lollipop.common.web.entity.service.ISubBaseService;
...
public abstract class SubBaseHandleController<Q extends SubBaseEntity<SD>, D extends SubBaseEntity<SD>, IDS extends ISubBaseService<Q, D, SQ, SD>, SQ extends BaseEntity, SD extends BaseEntity, ISS extends IBaseService<SQ, SD>> extends BaseController<Q, D, IDS> {
     ...
     *
     * @param d 待修改数据对象
     * @see com.lollipop.common.web.entity.controller.SubBaseController#edit(D)
     */
     ...
     *
     * @param d 待修改数据对象
     * @see com.lollipop.common.web.entity.controller.SubBaseController#editStatus(D)
     */
     ...
     * @see com.lollipop.common.web.entity.controller.SubBaseController#batchRemove(List)
     */
